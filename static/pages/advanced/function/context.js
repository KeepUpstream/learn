...
console.log("%c 执行方法getUrl():","color:red;font-size:20px");
	getUrl();
	console.log("%c 执行方法pseudoWindow.getUrl1():","color:red;font-size:20px");
	pseudoWindow.getUrl1();
	console.log("%c 执行方法pseudoWindow.getUrl2(getUrl):","color:red;font-size:20px");
	pseudoWindow.getUrl2(getUrl) 
	console.log(pseudoWindow)
	console.log("%c 执行方法pseudoWindow2.getUrl2(getUrl):","color:red;font-size:20px");
	pseudoWindow2.getUrl2(getUrl);
	console.log(pseudoWindow2)
